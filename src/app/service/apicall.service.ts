...
export class ApicallService {
  ...
  constructor(private http: HttpClient) {
    ...
    this.POSTARTICLE = this.APPEND_POINT + AppConstant.API_CONFIG.API_URL.API.ARTICLES;
    this.EDITARTICLE = this.APPEND_POINT + AppConstant.API_CONFIG.API_URL.API.EDIT_ARTICLE;
    this.DELETEARTICLE = this.APPEND_POINT + AppConstant.API_CONFIG.API_URL.API.DELETE_ARTICLE;
